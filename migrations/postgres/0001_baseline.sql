-- 0001_baseline — full schema per design §3a (postgres dialect).
-- Identical to the sqlite baseline except BLOB -> BYTEA; timestamps stay TEXT
-- (fixed-width UTC, lexicographic == chronological).
