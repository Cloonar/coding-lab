...
-- (sqlite dialect). Issue #19 / ADR-0021 splits AFK-run spawn defaults from the
-- manual pre-fill: repos gain optional AFK-override slots that resolve BEFORE
-- the base model_default/effort_default (NULL = inherit the base), plus a
